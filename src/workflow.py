...
class Workflow:
    ...
    def _research_step(self, state: ResearchState) -> Dict[str,Any]:
        ...
        if not extracted_tools:
            print("No extracted tools to research. Falling back to empty results.")
        ...
        for tool_name in tool_names:
            tool_search_results = self.firecrawl.search_companies(tool_name + " official website", num_results=1)
    ...
    def _analyze_steps(self, state: ResearchState) -> Dict[str,Any]:
